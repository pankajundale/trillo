...
(function() {
  ...
  Mobileapp.MobileappC = Trillo.inherits(Shared.AppC, function(viewSpec) {
    Shared.AppC.call(this, viewSpec);
  });

  var MobileappC = Mobileapp.MobileappC.prototype;
  var AppC = Shared.AppC.prototype;

  MobileappC.handleAction = function(actionName, selectedObj) {
