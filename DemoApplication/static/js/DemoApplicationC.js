...
(function() {
  ...
  DemoApplication.DemoApplicationC = Trillo.inherits(Shared.AppC, function(viewSpec) {
    Shared.AppC.call(this, viewSpec);
  });

  var DemoApplicationC = DemoApplication.DemoApplicationC.prototype;
  var AppC = Shared.AppC.prototype;

  DemoApplicationC.handleAction = function(actionName, selectedObj) {
